...
public class Main {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        TextAnalyzer c = new CosineSimilarityTextAnalyzer();
        String s1 = "Мама мыла раму, а я ничего не делал";
        String s2 = "Я совсем ничего не делал";
        double coef3 = c.analyze(new SimpleTextProvider(s1), new SimpleTextProvider(s2));
        ...
        System.out.println("Косинусное сходство для просто строк: " + coef3);
